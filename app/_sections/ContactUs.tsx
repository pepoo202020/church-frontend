    ...
    <section className="w-fit lg:w-full flex flex-col items-center justify-center pt-[28px] overflow-hidden gap-[21px] pb-5 text-white bg-[#185BB7]">
      ...
      <div className="w-full flex flex-col lg:flex-row items-start justify-center lg:gap-5 gap-5 my-2 px-2">
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start gap-2">
          ...
          <p className="cairo text-[31px] font-semibold text-white mb-2 text-center lg:text-start">
          ...
          <div className="w-full flex items-center justify-center lg:justify-start flex-wrap gap-5">
            {socialLinks.map(({ icon, link }, index) => (
              <Link
                ...
                className="bg-white w-[60px] h-[60px] md:w-[80px] md:h-[80px] rounded-full flex justify-center items-center group hover:bg-transparent transition-all duration-500"
              >
                {React.cloneElement(icon, {
                  fill: "#185BB7",
                  size: 30,
                  className:
                    "group-hover:fill-white transition-all duration-500 group-hover:scale-150",
                })}
              </Link>
            ))}
          </div>
        ...
        {/* Map Section */}
        <div className="w-full lg:w-1/3 border-2 border-white overflow-hidden rounded-2xl drop-shadow-2xl">
          <iframe
