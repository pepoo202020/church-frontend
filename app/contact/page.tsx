  ...
  return (
    <div>
      <SectionTitle
        ...
        image="sectionbg.png"
      >
        <SectionHeader title="التواصل معنا" align="center" color="blue" />
      </SectionTitle>
      <div className="w-full flex flex-col lg:flex-row items-start justify-center lg:gap-5 gap-5 my-10 px-2">
